...
void test_value_n_from_end_returns_correct_data() {
    printf("test value_n_from_end returns correct data\n");
    ...
    assert(value_n_from_end(new_ll, 0) == 6);
    assert(value_n_from_end(new_ll, 1) == 5);
    assert(value_n_from_end(new_ll, 3) == 3);
